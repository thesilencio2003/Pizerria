    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('ingredients.store') }}">
            ...
            <div class="mb-3">
                ...
                <div id="idHelp" class="form-text">ID del ingrediente (se genera automáticamente)</div>
            </div>
            <div class="mb-3">
                <label for="name" class="form-label">Nombre del Ingrediente</label>
                <input type="text" class="form-control" id="name" name="name" placeholder="Ingrese el nombre del ingrediente" required>
            </div>
