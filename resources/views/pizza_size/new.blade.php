...
<head>
    ...
    <title>Crear Tamaño de Pizza</title>
</head>
<body>
    <div class="container">
        <h1>Crear Tamaño de Pizza</h1>

        <form method="POST" action="{{ route('piza_size.store') }}">
            @csrf
            <div class="mb-3">
                <label for="id" class="form-label">ID</label>
                <input type="text" class="form-control" id="id" aria-describedby="idHelp" name="id" disabled>
                <div id="idHelp" class="form-text">ID del tamaño de pizza (se genera automáticamente)</div>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="price" name="price" step="0.01" placeholder="Ingrese el precio" required>
            </div>
